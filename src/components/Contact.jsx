      ...
      <div className="sm:p-10 my-auto">
        <section className="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
          <div className="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
            <div className="col-span-4 bg-[#f8f6c5]  px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
            ...
            <div className="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12">
              ...
              <p className="mt-2 mb-4 font-sans text-sm tracking-normal">
                Your observations and requests are important to us.
              </p>
              <form action="">
                ...
                <button
                  type="submit"
                  className="group flex cursor-pointer items-center rounded-xl bg-[#f8f6c5]  bg-none px-8 py-4 text-center font-semibold leading-tight text-blue-gray-900"
                >
                  Send
                  <svg
